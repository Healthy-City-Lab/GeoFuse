...
* **Compressed tiled BIGTIFF outputs with overviews**: Every GeoTIFF the project writes now uses DEFLATE compression with a float-aware predictor, 256×256 internal tiling, and BIGTIFF support; Reduces national-scale output size 5–10× compared to uncompressed writes.
